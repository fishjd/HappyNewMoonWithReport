...
public class F64_ceil {
	...
	public F64_ceil(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("a49abe1b-075c-471e-9685-b668417c6704"),
				opCodeName + ":"                                                                 //
