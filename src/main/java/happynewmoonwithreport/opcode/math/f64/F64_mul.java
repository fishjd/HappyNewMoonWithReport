...
public class F64_mul {
	...
	public F64_mul(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("974d5177-a2bc-4d83-866a-b0c93110b2c5"),
				opCodeName + ":"                                                                    //
		...
		// Assert: due to validation, a value of value type t is on the top of the stack.
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("d2abf6f9-225d-458d-afa5-9a64a322304b"),
				opCodeName + ":"                                                                    //
