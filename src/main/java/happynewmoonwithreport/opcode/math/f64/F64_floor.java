...
/**
 * Return the flooring value of the input.
 * </p>
 * <h2>Source:</h2>
 * <h3>Operator:</h3>
 * <p>
...
public class F64_floor {
	...
	public F64_floor(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("ecdb4539-acf9-4619-b804-9a9afec01bfa"),
				opCodeName + ":"                                                                 //
