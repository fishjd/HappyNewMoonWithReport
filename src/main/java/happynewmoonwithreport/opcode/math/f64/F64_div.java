...
public class F64_div {
	...
	public F64_div(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("d0c85207-c7b6-4f73-9b1b-ef2a6a6244a1"),
				opCodeName + ":"                                                                    //
		...
		// Assert: due to validation, a value of value type t is on the top of the stack.
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("2e040cea-f6dc-4547-a4fe-029f14c6a3ba"),
				opCodeName + ":"                                                                    //
