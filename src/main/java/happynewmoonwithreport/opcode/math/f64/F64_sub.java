...
public class F64_sub {
	...
	public F64_sub(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("384a85bf-c88b-4a16-868d-3e860d1747f3"),
				opCodeName + ":"                                                                    //
		...
		// Assert: due to validation, a value of value type t is on the top of the stack.
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("b5101f4f-74ef-41dc-a0cb-225e850daad2"),
				opCodeName + ":"                                                                    //
