...
public class F32_sqrt
{
	...
	public F32_sqrt(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F32) == false) {
			throw new WasmRuntimeException(UUID.fromString("0a4f1202-51b5-43dd-9baa-37476274b0d0"),
				opCodeName + ":"                                                                 //
