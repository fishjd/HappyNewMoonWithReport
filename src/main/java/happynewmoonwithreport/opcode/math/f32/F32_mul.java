...
/**
 * Return the multiplication value of the inputs.
 * </p>
 * <h2>Source:</h2>
 * <h3>Operator:</h3>
 * <p>
 * Return the multiplication value of the inputs.
 * <p>
 * <a href="https://webassembly.github.io/spec/core/exec/numerics.html#op-fmul" target="_top">
...
public class F32_mul {
	...
	public F32_mul(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F32) == false) {
			throw new WasmRuntimeException(UUID.fromString("4aad605b-2560-4df8-8e9e-d28d9b9f59ee"),
				opCodeName + ":"                                                                    //
		...
		// Assert: due to validation, a value of value type t is on the top of the stack.
		if ((stack.peek() instanceof F32) == false) {
			throw new WasmRuntimeException(UUID.fromString("99b7b695-0f8e-41c0-add8-2c89ccedc406"),
				opCodeName + ":"                                                                    //
