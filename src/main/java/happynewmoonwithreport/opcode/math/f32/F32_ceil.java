...
public class F32_ceil {
	...
	public F32_ceil(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F32) == false) {
			throw new WasmRuntimeException(UUID.fromString("9f262b14-177c-4fac-80ea-46a8b05ef2b2"),
				opCodeName + ":"                                                                 //
