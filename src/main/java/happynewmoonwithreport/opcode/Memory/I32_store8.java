...
/**
 * <h1>i32_store8</h1> Store 8 bits from the stack to memory.
 * <br>
 ...
 * </ol>
 */
public class I32_store8 extends StoreBase {

	private I32_store8() {
		super();
	}

	public I32_store8(MemoryArgument memoryArgument, WasmFrame frame, WasmStore store,
					  WasmStack stack) {
