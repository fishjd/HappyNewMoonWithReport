 ...
 * </ol>
 */
public class I64_store8 extends StoreBase {

	private I64_store8() {
		super();
	}

	public I64_store8(MemoryArgument memoryArgument, WasmFrame frame, WasmStore store,
		WasmStack stack) {
	...
	ByteUnsigned[] step13_convert_C_toByteArray() {
		...
		result[6] = ByteUnsigned.byteUnsignedZero;
		result[7] = baC[7];
