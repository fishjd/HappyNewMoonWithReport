...
public class F64_ne {
	...
	public F64_ne(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("b34836dc-5029-4438-9453-5c43609f52a1"),
				"f6_ne: Value2 type is incorrect");
		}
		...
		// 1. Assert: due to validation, two values of value type t are on the top of the stack.
		if ((stack.peek() instanceof F64) == false) {
			throw new WasmRuntimeException(UUID.fromString("6279ddd3-ab6f-402f-be03-ae22f98326fa"),
				"f6_ne: Value1 type is incorrect");
		}
