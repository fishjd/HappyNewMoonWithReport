...
public class I64_xor {
	...
	public I64_xor(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof I64) == false) {
			throw new WasmRuntimeException(UUID.fromString("9c84ca92-03d7-4704-8512-cb101eddb145"),
		...
		if ((stack.peek() instanceof I64) == false) {
			throw new WasmRuntimeException(UUID.fromString("906ef7e6-f120-4b6f-919a-857f32975cc8"),
