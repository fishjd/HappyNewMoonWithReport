...
public class I32_rotr {
	...
	public I32_rotr(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof I32) == false) {
			throw new WasmRuntimeException(UUID.fromString("15a589e5-8ca4-4d9e-a664-0bf4cf22fbf9"),
