...
public class I64_rotl {
	...
	public I64_rotl(WasmInstanceInterface instance) {
		this();
	...
	public void execute() {
		...
		if ((stack.peek() instanceof I64) == false) {
			throw new WasmRuntimeException(UUID.fromString("a45465fe-4ab1-474b-b702-a1526b292d42"),
		...
		if ((stack.peek() instanceof I64) == false) {
			throw new WasmRuntimeException(UUID.fromString("2bee7bd5-2dcf-40e7-8c27-118fea841bf9"),
		...
		I64 result = new I64(Long.rotateLeft(value1.longValue(), k));
