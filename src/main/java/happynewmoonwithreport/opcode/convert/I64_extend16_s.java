 ...
 * <br>
 * Extend the least significant 16 bits to 64 bits signed.  The 16 least significant bits are
...
public class I64_extend16_s {
	...
	private I64_extend16_s() {
		super();
	}

	public I64_extend16_s(WasmInstanceInterface instance) {
		this();
