...
public class VarInt32Test {
    ...
    public void testReadSigned() {
        ...
        NumberHelper.assertEqualHex(new VarInt32(-624485L).LongValue(), new VarInt32(bytesAll).LongValue());
    }
    ...
    public void testReadSignedPadded() {
        ...
        NumberHelper.assertEqualHex(new VarInt32(-624485L).LongValue(), new VarInt32(bytesAll).LongValue());
        assertEquals(new Integer(4), new VarInt32(bytesAll).size());
    }
    ...
    public void testReadSignedPaddedNeg2() {
        ...
        NumberHelper.assertEqualHex(new VarInt32(-2).LongValue(), new VarInt32(bytesAll).LongValue());
        assertEquals(new Integer(1), new VarInt32(bytesAll).size());

        bytesAll = new byte[]{(byte) 0xFE, (byte) 0x7F};
        NumberHelper.assertEqualHex(new VarInt32(-2).LongValue(), new VarInt32(bytesAll).LongValue());
        assertEquals(new Integer(2), new VarInt32(bytesAll).size());

        bytesAll = new byte[]{(byte) 0xFE, (byte) 0xFF, (byte) 0x7F};
        NumberHelper.assertEqualHex(new VarInt32(-2).LongValue(), new VarInt32(bytesAll).LongValue());
        assertEquals(new Integer(3), new VarInt32(bytesAll).size());
        ...
        NumberHelper.assertEqualHex(new VarInt32(-2).LongValue(), new VarInt32(bytesAll).LongValue());
        assertEquals(new Integer(5), new VarInt32(bytesAll).size());
    }
