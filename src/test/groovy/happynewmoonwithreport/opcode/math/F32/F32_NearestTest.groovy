 ...
 */
class F32_NearestTest extends Specification {
	String inputType;
	String returnType;
 ...
 * @return None.
 */
	def "Execute F32_nearest with #count -> #val1 || #expected "(Integer count, Float val1, Float expected) {
...
//		1     | 4.1       || 4.0
	 ...
	 * @return None.
	 */
	def "Execute F32 nearest #count | #val1_s  || #expected"(Integer count, String val1_s, String expected) {
	...
	def "Execute F32_nearest Canonical"() {
		setup: " push ONE value on stack."
	...
	def "Execute F32_nearest throws exception on incorrect Type on first param "() {
		...
		F32_nearest function = new F32_nearest(instance);
