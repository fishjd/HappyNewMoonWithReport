...
import happynewmoonwithreport.opcode.math.f32.F32_add
 ...
 */
class F32_addTest extends Specification {
	String inputType;
	String returnType;
	 ...
	 * @return None.
	 */
	def "Execute F32_add with #count -> #val1 | #val2 || #expected "(Integer count, Float val1, Float val2, Float expected) {
		...
		F32_add opcode = new F32_add(instance);
	 ...
	 * @return None.
	 */
	def "Execute F32 Add  #count | #val1_s | #val2_s  || #expected"(Integer count, String val1_s, String val2_s, String expected) {
		...
		45    | "-0x1p-149"        | "-0x1p-149"        || "-0x1p-148"
		46    | "-0x1p-149"        | "0x1p-149"         || "0x0p+0"
		47    | "0x1p-149"         | "-0x1p-149"        || "0x0p+0"
		48    | "0x1p-149"         | "0x1p-149"         || "0x1p-148"
		49    | "-0x1p-149"        | "-0x1p-126"        || "-0x1.000002p-126"
		50    | "-0x1p-149"        | "0x1p-126"         || "0x1.fffffcp-127"
		51    | "0x1p-149"         | "-0x1p-126"        || "-0x1.fffffcp-127"
		52    | "0x1p-149"         | "0x1p-126"         || "0x1.000002p-126"
		...
		85    | "-0x1p-126"        | "-0x1p-149"        || "-0x1.000002p-126"
		86    | "-0x1p-126"        | "0x1p-149"         || "-0x1.fffffcp-127"
		87    | "0x1p-126"         | "-0x1p-149"        || "0x1.fffffcp-127"
		88    | "0x1p-126"         | "0x1p-149"         || "0x1.000002p-126"
		89    | "-0x1p-126"        | "-0x1p-126"        || "-0x1p-125"
		90    | "-0x1p-126"        | "0x1p-126"         || "0x0p+0"
		91    | "0x1p-126"         | "-0x1p-126"        || "0x0p+0"
		92    | "0x1p-126"         | "0x1p-126"         || "0x1p-125"
		...
		141   | "-0x1p-1"          | "-0x1.921fb6p+2"   || "-0x1.b21fb6p+2"
		142   | "-0x1p-1"          | "0x1.921fb6p+2"    || "0x1.721fb6p+2"
		143   | "0x1p-1"           | "-0x1.921fb6p+2"   || "-0x1.721fb6p+2"
		144   | "0x1p-1"           | "0x1.921fb6p+2"    || "0x1.b21fb6p+2"
		...
		181   | "-0x1p+0"          | "-0x1.921fb6p+2"   || "-0x1.d21fb6p+2"
		182   | "-0x1p+0"          | "0x1.921fb6p+2"    || "0x1.521fb6p+2"
		183   | "0x1p+0"           | "-0x1.921fb6p+2"   || "-0x1.521fb6p+2"
		184   | "0x1p+0"           | "0x1.921fb6p+2"    || "0x1.d21fb6p+2"
		...
		213   | "-0x1.921fb6p+2"   | "-0x1p-1"          || "-0x1.b21fb6p+2"
		214   | "-0x1.921fb6p+2"   | "0x1p-1"           || "-0x1.721fb6p+2"
		215   | "0x1.921fb6p+2"    | "-0x1p-1"          || "0x1.721fb6p+2"
		216   | "0x1.921fb6p+2"    | "0x1p-1"           || "0x1.b21fb6p+2"
		217   | "-0x1.921fb6p+2"   | "-0x1p+0"          || "-0x1.d21fb6p+2"
		218   | "-0x1.921fb6p+2"   | "0x1p+0"           || "-0x1.521fb6p+2"
		219   | "0x1.921fb6p+2"    | "-0x1p+0"          || "0x1.521fb6p+2"
		220   | "0x1.921fb6p+2"    | "0x1p+0"           || "0x1.d21fb6p+2"
		221   | "-0x1.921fb6p+2"   | "-0x1.921fb6p+2"   || "-0x1.921fb6p+3"
		222   | "-0x1.921fb6p+2"   | "0x1.921fb6p+2"    || "0x0p+0"
		223   | "0x1.921fb6p+2"    | "-0x1.921fb6p+2"   || "0x0p+0"
		224   | "0x1.921fb6p+2"    | "0x1.921fb6p+2"    || "0x1.921fb6p+3"
		...
		266   | "-0x1.fffffep+127" | "0x1.fffffep+127"  || "0x0p+0"
		267   | "0x1.fffffep+127"  | "-0x1.fffffep+127" || "0x0p+0"
	...
	def "Execute F32_add throws exception on incorrect Type on second param "() {
		...
		F32_add function = new F32_add(instance);
	...
	def "Execute F32_add throws exception on incorrect Type on first param "() {
		setup: " a value of F32  value"
		WasmInstanceInterface instance = new WasmInstanceStub();
