 ...
 * <a href="https://github.com/WebAssembly/testsuite/blob/c17cd7f4e379b814055c82fcc0fc1f6202ba9e2a/i32.wast#L158">
 *      WebAssembly Test Suite i32.wast
 * </a>
 *
 */
class I32_xorTest extends Specification {
	...
	def "I32_or val1 = #val1 val2 = #val2 expected = #expected"(Integer val1, Integer val2, Integer expected) {
		...
		and: "an opcode"
		I32_xor i32_xor = new I32_xor(instance);
		...
		-1          | 0x8000_0000 || 0x7FFF_FFFF
		-1          | 0x7FFF_FFFF || 0x8000_0000
		0xF0F0_FFFF | 0xFFFF_F0F0 || 0x0F0F_0F0F
		0xFFFF_FFFF | 0xFFFF_FFFF || 0
	}

	def "I32_xor throws exception on incorrect type on second parameter"() {
		...
		exception.message.contains("I32_xor");
		exception.message.contains("Value should be of type I32");
		exception.getUuid() == UUID.fromString("533f0b47-5b00-4b38-a235-55b47a00e411");
	}

	def "I32_xor throws exception on incorrect type on first parameter"() {
		...
		exception.message.contains("I32_xor");
		exception.message.contains("Value should be of type I32");
		exception.getUuid() == UUID.fromString("6b807dd8-b620-4e94-a937-e2160ee7ba80");
	}
}
