...
/**
 * Test I64_shr_uTest opcode.
 * <br>
 * Some test cases are from:
 * <a href="https://github.com/WebAssembly/testsuite/blob/c17cd7f4e379b814055c82fcc0fc1f6202ba9e2a/i64.wast#L200">
 *      WebAssembly Test Suite i64.wast
 * </a>
 *
 */
class I64_shr_uTest extends Specification {
	...
	// @Unroll
	def "I64_shr_u val1 = #val1 val2 = #val2 expected = #expected"(Long val1, Long val2, Long expected) {
		...
		and: "an opcode"
		I64_shr_u i64_shr_u = new I64_shr_u(instance);
		...
		1                     | 1                     || 0
		1                     | 0                     || 1
		-1                    | 1                     || 0x7FFF_FFFF_FFFF_FFFF
		0x7FFF_FFFF_FFFF_FFFF | 1                     || 0x3FFF_FFFF_FFFF_FFFF
		0x8000_0000_0000_0000 | 1                     || 0x4000_0000_0000_0000
		...
		-1                    | 64                    || -1
		-1                    | 65                    || 0x7FFF_FFFF_FFFF_FFFF
		-1                    | -1                    || 1
		-1                    | 0x7FFF_FFFF_FFFF_FFFF || 1
		-1                    | 0x8000_0000_0000_0000 || -1
	}

	def "I64_shr_u throws exception on incorrect type on second parameter"() {
		...
		exception.message.contains("I64_shr_u");
	...
	def "I64_shr_u throws exception on incorrect type on first parameter"() {
		...
		exception.message.contains("I64_shr_u");
		exception.message.contains("Value should be of type I64");
		exception.getUuid() == UUID.fromString("2fd7f9c9-c84c-4181-9acc-013dc420ab05");
	}
}
